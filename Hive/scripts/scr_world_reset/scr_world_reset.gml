...
scr_world_room_reset(global.worldGrid[# control_x, control_y], SHAPE.SMALL);
		...
		switch (roomShape) {
			...
			case SHAPE.BIG:	
				...
				if (_control1_x < 0 || _control1_y < 0 || _control1_x >= ds_grid_width(global.worldGrid) || _control1_y >= ds_grid_height(global.worldGrid) ||
					...
					scr_world_room_reset(global.worldGrid[# control_x, control_y], SHAPE.BIG);
					isCreateRoom = true;
				}
				break;
			#endregion
			...
			case SHAPE.WLONG:	
				...
				if (_control1_x < 0 || _control1_y < 0 || _control1_x >= ds_grid_width(global.worldGrid) || _control1_y >= ds_grid_height(global.worldGrid) ||
					...
					ds_grid_set_region(global.worldGrid, _control1_x, _control1_y, _control2_x, _control2_y, i);
					scr_world_room_reset(global.worldGrid[# control_x, control_y], SHAPE.WLONG);
					isCreateRoom = true;
				}
				break;
			#endregion
			...
			case SHAPE.HLONG:	
				...
				if (_control1_x < 0 || _control1_y < 0 || _control1_x >= ds_grid_width(global.worldGrid) || _control1_y >= ds_grid_height(global.worldGrid) ||
					...
					ds_grid_set_region(global.worldGrid, _control1_x, _control1_y, _control2_x, _control2_y, i);
					scr_world_room_reset(global.worldGrid[# control_x, control_y], SHAPE.HLONG);
					isCreateRoom = true;
				}
				break;
			#endregion
